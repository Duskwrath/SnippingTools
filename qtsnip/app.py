...
def parse_args(argv: list[str]) -> LaunchOptions:
    ...
    parser.add_argument("--delay", type=int, choices=[0, 3, 5, 10], help="Delay capture by seconds")
    ...
    return LaunchOptions(args.new, args.fullscreen, args.delay, args.output, args.copy)
